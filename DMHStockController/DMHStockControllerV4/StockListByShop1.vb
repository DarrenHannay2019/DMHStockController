...
Public Class StockListByShop
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DMHStockControllerV4.StockListByShop.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockListByShop
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockListByShop = New StockListByShop()
        rpt.Site = Me.Site
        Return rpt
    End Function
