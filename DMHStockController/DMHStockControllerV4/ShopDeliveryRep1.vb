...
Public Class ShopDeliveryRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DMHStockControllerV4.ShopDeliveryRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShopDeliveryRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShopDeliveryRep = New ShopDeliveryRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
