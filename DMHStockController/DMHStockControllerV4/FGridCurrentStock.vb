...
Public Class FGridCurrentStock
    ...
    Private Sub TsbPrint_Click(sender As Object, e As EventArgs) Handles TsbPrint.Click
        Dim print As New FReportViewer With {.Text = "Print Current Stock"}
        print.Show()
    End Sub
    ...
    Private Sub FGridCurrentStock_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub LoadData()
        Try
            Using conn As New SqlConnection(ut.GetConnString())
                ...
                conn.Open()
                ad.SelectCommand = New SqlCommand("SELECT * from qryStockvaluespc1 Where DeadCode=0 order by StockCode", conn)
                ad.Fill(dt)
            ...
            'Dead Code
            DataGridView1.Columns.Item(2).Visible = False                       ' Hides the coloum from view
