...
Public Class ShopDelGrid
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DMHStockControllerV4.ShopDelGrid.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShopDelGrid
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShopDelGrid = New ShopDelGrid()
        rpt.Site = Me.Site
        Return rpt
    End Function
