...
Public Class TotalValueRep
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DMHStockControllerV3.TotalValueRep.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTotalValueRep
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TotalValueRep = New TotalValueRep()
        rpt.Site = Me.Site
        Return rpt
    End Function
