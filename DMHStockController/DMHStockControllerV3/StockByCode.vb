...
Public Class StockByCode
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DMHStockControllerV3.StockByCode.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStockByCode
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StockByCode = New StockByCode()
        rpt.Site = Me.Site
        Return rpt
    End Function
