...
Public Class Form1
    ...
    Private Sub NewToolStripButton_Click(sender As Object, e As EventArgs) Handles NewToolStripButton.Click
        ...
        If txtOption.Text = "Seasons" Then FSeasons.Show()
        If txtOption.Text = "Profile" Then FProfile.Show()
        If txtOption.Text = "Suppliers" Then FSuppliersEntry.Show()
        If txtOption.Text = "Warehouses" Then FWarehouse.Show()
        ...
        If txtOption.Text = "Warehouse Transfers" Then FWarehouseTransfer.Show()
        ...
        If txtOption.Text = "Sales" Then FSales.Show()
        If txtOption.Text = "Refunds" Then FRefunds.Show()
        If txtOption.Text = "Shop Adjustments" Then FShopAdjustments.Show()
        If txtOption.Text = "Returns" Then FReturns.Show()
        If txtOption.Text = "Employee" Then FEmployee.Show()
    End Sub
